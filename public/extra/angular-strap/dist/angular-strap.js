    ...
    return {
      ...
      link: function postLink(scope, element, attr, controller) {
        ...
        controller.$render = function () {
          ...
          var selected = angular.isDefined(index) ? typeahead.$scope.$matches[index].value : controller.$viewValue;
          selected = angular.isObject(selected) ? selected.value : selected;
